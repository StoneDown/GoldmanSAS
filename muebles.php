...
<head>
  ...
  <title>GoldManSAS - Muebles de Casa</title>
  ...
  <div class="productos">
    ...
    <div class="producto">
      ...
      <div class="producto-info">
        ...
        <p>$2,500,000</p>
        <button class="agregar" onclick="agregarAlCarritoAnimado(this, 13, 'Sofá Modular de Sala', 2500000)">Agregar al carrito</button>
      </div>
    </div>
    ...
    <div class="producto">
      ...
      <div class="producto-info">
        ...
        <p>$1,800,000</p>
        <button class="agregar" onclick="agregarAlCarritoAnimado(this, 14, 'Mesa de Comedor 6 Puestos', 1800000)">Agregar al carrito</button>
      </div>
    </div>
    ...
    <div class="producto">
      ...
      <div class="producto-info">
        ...
        <p>$500,000</p>
        <button class="agregar" onclick="agregarAlCarritoAnimado(this, 15, 'Estantería de Madera', 500000)">Agregar al carrito</button>
      </div>
    </div>
    ...
    <div class="producto">
      ...
      <div class="producto-info">
        ...
        <p>$350,000</p>
        <button class="agregar" onclick="agregarAlCarritoAnimado(this, 16, 'Mesa de Centro', 350000)">Agregar al carrito</button>
      </div>
    </div>
  </div>
