...
document.getElementById("carrito-icon").addEventListener("click", () => {
    ...
    <body>
        <header class="main-header">
            ...
            <nav>
                <a href="inicio.php" class="nav-link">Login</a>
                ...
                <a href="javascript:void(0);" class="nav-link" id="idioma-link">
                    <img src="UnitedStates.png" width="20" height="20" alt="Idioma icon">
                    Language
                </a>
        ...
        <div id="idioma-dropdown" class="menu-dropdown">
            ...
            <div id="idiomas" class="submenu">
                <p><a href="index.php">Spanish</a></p>
                <p><a href="index_en.php">English</a></p>
                <p><a href="index_fr.php">French</a></p>
                <p><a href="index_pt.php">Portuguese</a></p>
            </div>
        </div>
        ...
        <div id="menu-dropdown" class="menu-dropdown">
            ...
            <div class="menu-section">
                ...
                <div id="articulos" class="submenu">
                    <p><a href="cocina.php">Kitchen</a></p>
                    <p><a href="exteriores.php">Exteriors</a></p>
                    <p><a href="dormitorio.php">Bedroom</a></p>
                    <p><a href="muebles.php">Furniture</a></p>
                </div>
            </div>
        </div>
        <!-- Menú desplegable para Usuario -->
        <div id="usuario-dropdown" class="menu-dropdown">
            <h3 id="usuario-nombre">User</h3>
            <p><a href="ajustes.php">Settings</a></p>
            <p><a href="confirmar_correo.php">Confirm Email</a></p>
        </div>

        <!-- Menú desplegable para Carrito -->
        <div id="carrito-dropdown" class="menu-dropdown">
            <h3>Cart</h3>
            <p><a href="carrito.php">See Products</a></p>
        </div>
        ...
        <h6>Page made by Samuel Felipe Uribe</h6>
    </body>
</html>